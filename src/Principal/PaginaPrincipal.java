...
public class PaginaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(18, 13, 53));
        ...
        jButton2.setBackground(new java.awt.Color(18, 13, 53));
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Principal/Recursos/menos.png"))); // NOI18N
        ...
        jButton3.setBackground(new java.awt.Color(0, 134, 170));
        ...
        jButton4.setBackground(new java.awt.Color(0, 134, 170));
        jButton4.setFont(new java.awt.Font("Malgun Gothic", 1, 12)); // NOI18N
        jButton4.setText("COMPUTADORA");
        ...
        jButton5.setBackground(new java.awt.Color(0, 134, 170));
        jButton5.setFont(new java.awt.Font("Malgun Gothic", 1, 12)); // NOI18N
        jButton5.setText("SISTEMAS OPERATIVOS");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Principal/Recursos/ordenador-personal (1).png"))); // NOI18N

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText(" copyright 2024 Daniel steven arroyoflorez © ");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        VentanaSistemasOperativos ventana = new VentanaSistemasOperativos(this, true);
        ventana.setLocationRelativeTo(this);
        ventana.setVisible(true); 
